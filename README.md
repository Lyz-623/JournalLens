...
| Daily feed cache / 每日缓存 | Reuses the same day's fetched papers after Zotero restarts; the Refresh button always fetches again. |
...
| Zotero settings / 设置项 | Configure language, fetch window, translation provider, research-content filtering and figure loading. |
